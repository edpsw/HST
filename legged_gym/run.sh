...
python legged_gym/scripts/train.py --run_name 0323-1  --sim_device cuda:0 --rl_device cuda:0 --task=g1    #  --headless --no_wandb
python legged_gym/scripts/play.py --load_run 0323-1   --sim_device cuda:0 --rl_device cuda:0 --task=g1   --checkpoint -1 #    --checkpoint -1
